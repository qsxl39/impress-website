...
const __VLS_0 = __VLS_asFunctionalComponent(AppHeader, new AppHeader({
    themeClass: "railway-theme",
}));
const __VLS_1 = __VLS_0({
    themeClass: "railway-theme",
}, ...__VLS_functionalComponentArgsRest(__VLS_0));
__VLS_asFunctionalElement(__VLS_intrinsicElements.main, __VLS_intrinsicElements.main)({
    ...{ class: "railway-container" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "hero" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "gear gear-top-left" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    'class.bind': "gear gear-top-right",
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "hero-content" },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "gear gear-bottom-left" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "gear gear-bottom-right" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
/** @type {__VLS_StyleScopedClasses['railway-theme']} */ ;
/** @type {__VLS_StyleScopedClasses['railway-container']} */ ;
/** @type {__VLS_StyleScopedClasses['hero']} */ ;
/** @type {__VLS_StyleScopedClasses['gear']} */ ;
/** @type {__VLS_StyleScopedClasses['gear-top-left']} */ ;
/** @type {__VLS_StyleScopedClasses['hero-content']} */ ;
/** @type {__VLS_StyleScopedClasses['gear']} */ ;
/** @type {__VLS_StyleScopedClasses['gear-bottom-left']} */ ;
/** @type {__VLS_StyleScopedClasses['gear']} */ ;
/** @type {__VLS_StyleScopedClasses['gear-bottom-right']} */ ;
